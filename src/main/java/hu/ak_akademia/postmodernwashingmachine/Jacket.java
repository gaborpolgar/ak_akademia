...
public class Jacket extends Clothes implements Washable{
    ...
    private int wet;
    private static final int DUR_CUT_RATE = 1;

    public Jacket(String name, Color color, int dirty) {
